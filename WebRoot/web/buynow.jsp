...
<script type="text/javascript">
  ...
  if(checkAdd()&&checkName()&&checkZipcode()&&checkTel()&&checkPro()) {
  return true;
  } else {
  alert("请填完整收货信息！");
  return false;
...
<body>
	...
	<%
		...
		if (loName != null) {
			...
			if (gouwuList.size() != 0 && gouwuList != null) {
				...
				String discount = gouwuList.get(0).get("DISCOUNT");
				if (discount.equals("10")) {
					discount = "无";
				}
				String img = gouwuList.get(0).get("IMG");
	...
	<div id="wrap">
		<!--top-->
		<form
			action="/myshoppingsys/goodsServlet?flag=tijiaodindanbuynow&loName=<%=loName%>&num=<%=num%>"
		...
		<div id="content">
							...
							List<Map<String, String>> provinceList = (List<Map<String, String>>) request
									...
									if (provinceList != null && provinceList.size() > 0) {
										for (int i = 0; i < provinceList.size(); i++) {
											...
											String proid = provinceList.get(i)
													.get("PROVINCEID");
			...
			<div id="board2">
				...
				<p>支付方式：</p>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" value="在线" name="zhifu" id="zaixian" />在线支付&nbsp;&nbsp;&nbsp;&nbsp;
